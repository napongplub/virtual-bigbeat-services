...
class NotifyExhibitorMessage extends Mailable implements ShouldQueue {
    ...
    public function build() {
        ...
        return $this->from('cebit-2020@varpevent.com', 'CEBIT ASEAN THAILAND')
                    ...
                    ->to($this->data["email"])->view('email.notifyunreadexhibitor', $data_rp);
    }
}
